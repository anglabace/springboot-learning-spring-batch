...
public class JobConfiguration {
	...
	public JdbcPagingItemReader<Customer> pagingItemReader() {
		System.out.println("JobConfiguration.pagingItemReader()");
	...
	public UpperCaseItemProcessor itemProcessor() {
		System.out.println("JobConfiguration.itemProcessor()");
		return new UpperCaseItemProcessor();
	}

	@Bean
	public Step step1() throws Exception {
		System.out.println("JobConfiguration.step1()");
	...
	public Job job() throws Exception {
		System.out.println("JobConfiguration.job()");
		return jobBuilderFactory.get("itemProcessorInterface")
				.start(step1())
				.build();
	}
}
